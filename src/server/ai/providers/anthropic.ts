...
export class AnthropicProvider implements AIProvider {
  ...
  // Model is supplied by the caller rather than hardcoded here — different
  // capabilities (routine extraction vs. a harder task that warrants a
  // stronger model) can each instantiate this class with their own choice,
  // without touching the provider mechanism itself.
